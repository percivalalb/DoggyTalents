...
- Then download a version of forge from this [link](files.minecraftforge.net/).
- Once you have either the jar or exe installation of Minecraft Forge downloaded, open it up.
- Select the 'Install client' option and click OK. Minecraft Forge should now be installed!
...
- Then download a version of forge from this [link](files.minecraftforge.net/).
- Once you have either the jar or exe installation of Minecraft Forge downloaded, open it up.
- Select the 'Install server' option, select a folder of your choice, and click OK. Minecraft Forge should now be installed with a new folder and files: `libraries` folder, `minecraft_server.MCVersionHere.jar`, and `forge-build-universal.jar`
