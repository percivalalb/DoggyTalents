...
import doggytalents.entity.doggyhelper.ModelHelper;
...
public class ModelDTDoggy extends ModelBase
{
    ...
    {
        EntityDTDoggy entitywolf = (EntityDTDoggy)entityliving;
        ...
        float f3 = ModelHelper.getBegAngle(entitywolf, f2) + entitywolf.getShakeAngle(f2, 0.0F);
        ...
        {
            float f4 = entitywolf.getBrightness(f2) * entitywolf.getShadingWhileShaking(f2);
