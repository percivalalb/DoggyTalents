...
public class PestFighter extends ITalent {
	...
	public void onLivingUpdate(EntityDog dog) {
		...
		if(level >= 0) {
            ...
            List list = dog.world.getEntitiesWithinAABB(EntitySilverfish.class, new AxisAlignedBB(dog.posX, dog.posY, dog.posZ, dog.posX + 1.0D, dog.posY + 1.0D, dog.posZ + 1.0D).expand(level * 3, 4D, level * 3));
