...
public class BiomesOPlentyLib {
    ...
    public static final String[] PLANKS_1_TEXURE = new String[] {"sacred_oak_planks", "cherry_planks", "umbran_planks", "fir_planks", "ethereal_planks", "magic_planks", "mangrove_planks", "palm_planks", "redwood_planks", "willow_planks", "pine_planks", "hellbark_planks", "jacaranda_planks", "mahogany_planks", "ebony_planks", "eucalyptus_planks"};
