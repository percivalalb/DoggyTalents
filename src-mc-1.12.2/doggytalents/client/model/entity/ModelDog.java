...
public class ModelDog extends ModelBase {
	...
	public ModelDog(float scaleFactor) {
        ...
        //Tail3
        this.wolfTail.setTextureOffset(43, 19).addBox(-0.5F, 0F, -2F, 3, 10, 3);
		...
		//HeadMain EarsBoni
        this.wolfHeadMain.setTextureOffset(36, 13).addBox(-3.0F, -3.0F, -1.5F, 1, 5, 3, scaleFactor);
        this.wolfHeadMain.setTextureOffset(36, 13).addBox(4.0F, -3.0F, -1.5F, 1, 5, 3, scaleFactor);
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        ...
        if(this.isChild) {
        	...
        	GlStateManager.pushMatrix();
            GlStateManager.scale(1.0F, dog.isDwarf()?0.8F:1.0F, 1.0F);
        	GlStateManager.translate(0.0F, dog.isDwarf()?(6.0F * scale):0.0F, 0.0F);
        	(dog.hasBone() ? this.wolfHeadMainBone : this.wolfHeadMain).renderWithRotation(scale);
        	this.wolfBody.render(scale);
            this.wolfLeg1.render(scale);
            this.wolfLeg2.render(scale);
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        if (dog.isSitting()) {
        	...
        	if(flag2 || flag3) {
        		this.wolfHeadMain.setRotationPoint(-1, 19.5F, -7);
        		this.wolfBody.setRotationPoint(0, 20, 2);
        		this.wolfBody.rotateAngleX = ((float)Math.PI / 2F);
        		this.wolfMane.setRotationPoint(-1, 20, -2);
        		this.wolfMane.rotateAngleX = this.wolfBody.rotateAngleX;
        		this.wolfTail.setRotationPoint(-1, 18, 8);
        		this.wolfLeg1.setRotationPoint(-4.5F, 23, 7);
        		this.wolfLeg1.rotateAngleX = -1.570796F;
        		this.wolfLeg2.setRotationPoint(2.5F, 23, 7);
        		this.wolfLeg2.rotateAngleX = -1.570796F;
        		this.wolfLeg3.setRotationPoint(-4.5F, 23, -4);
        		this.wolfLeg3.rotateAngleX = -1.570796F;
        		this.wolfLeg4.setRotationPoint(2.5F, 23, -4);
        		this.wolfLeg4.rotateAngleX = -1.570796F;
        	}
        	else {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        EntityDog dog = (EntityDog) entityIn;
        boolean flag1 = dog.isSitting();
        boolean flag2 = dog.getOwner() != null && dog.getOwner().isPlayerSleeping();
        boolean flag3 = dog.world.getBlockState(dog.getPosition().down()).getBlock() == ModBlocks.DOG_BED || dog.world.getBlockState(dog.getPosition().down()).getBlock() == Blocks.BED;
        boolean flag = flag1 && (flag2 || flag3);
        
        this.wolfHeadMain.rotateAngleX = headPitch * 0.017453292F;
        this.wolfHeadMain.rotateAngleY = netHeadYaw * (flag?0.005F:0.017453292F);
