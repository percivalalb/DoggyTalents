...
public class EntityDog extends EntityAbstractDog /*implements IRangedAttackMob*/ { //TODO RangedAttacker
    ...
    public void onLivingUpdate() {
        ...
        if(!this.isDead) { //Prevent the data from being added when the entity dies
            if(Constants.DEBUG_MODE == true) System.out.println("Update/Add Request From Living");
            this.locationManager.addOrUpdateLocation(this);
        }else{
            if(Constants.DEBUG_MODE == true) System.out.println("Remove Request From Living");
