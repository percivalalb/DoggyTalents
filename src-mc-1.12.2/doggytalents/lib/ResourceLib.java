...
public class ResourceLib {
	...
	public static final ResourceLocation MOB_LAYER_CAPE_COLOURED = new ResourceLocation("doggytalents", getMobTexturePath("doggy_cape_coloured.png"));
	...
	public static final ResourceLocation MOB_LAYER_GUARD_SUIT = new ResourceLocation("doggytalents", getMobTexturePath("doggy_guard_suit.png"));
	public static final ResourceLocation MOB_LAYER_LEATHER_JACKET_BONI = new ResourceLocation("doggytalents", getMobTexturePath("doggy_leather_jacket_boni.png"));
	...
	public static final ResourceLocation MOB_LAYER_ARMOR_OVERLAY = new ResourceLocation("doggytalents", getMobTexturePath("doggy_armor_overlay.png"));
	public static final ResourceLocation MOB_LAYER_WOODEN_ARMOR = new ResourceLocation("doggytalents", getMobTexturePath("doggy_wooden_armor.png"));
	public static final ResourceLocation MOB_LAYER_BONE_ARMOR = new ResourceLocation("doggytalents", getMobTexturePath("doggy_bone_armor.png"));
	public static final ResourceLocation MOB_LAYER_ACCESORIES = new ResourceLocation("doggytalents", getMobTexturePath("doggy_accesories.png"));
