...
public class ItemList {
	...
	public void registerItem(Item item, int meta) {
		...
		if(this.itemlist.contains(array))
			DoggyTalents.LOGGER.warn("The item %s meta %d is already registered in this item list", item, meta);
		else {
			this.itemlist.add(array);
			DoggyTalents.LOGGER.info("The item %s meta %d was register to an item list", item, meta);
		}
	}
