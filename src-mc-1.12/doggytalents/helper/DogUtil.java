...
public class DogUtil {
	...
	public static void teleportDogToOwner(Entity owner, Entity entity, World world, PathNavigate pathfinder) {
        ...
        for(int l = 0; l <= 4; ++l) {
            for(int i1 = 0; i1 <= 4; ++i1) {
                if((l < 1 || i1 < 1 || l > 3 || i1 > 3) && DogUtil.canTeleportToLocation(entity, world, i, j, k, l, i1)) {
    ...
    public static boolean canTeleportToLocation(Entity entity, World world, int xBase, int zBase, int y, int xAdd, int zAdd) {
