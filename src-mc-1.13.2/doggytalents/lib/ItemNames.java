...
public class ItemNames {
    ...
    public static final String BREEDING_BONE = Reference.MOD_ID + ":breeding_bone";
    public static final String COLLAR_SHEARS = Reference.MOD_ID + ":collar_shears";
    public static final String DOGGY_CHARM = Reference.MOD_ID + ":doggy_charm";
    public static final String RADIO_COLLAR = Reference.MOD_ID + ":radio_collar";
    public static final String WOOL_COLLAR = Reference.MOD_ID + ":wool_collar";
    public static final String CREATIVE_COLLAR = Reference.MOD_ID + ":creative_collar";
