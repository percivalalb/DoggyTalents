...
public class ItemPhysicAPI {
	...
	public void addSortingBlocks(String sortingListName, Block... blocks) throws Exception {
		...
		for(Block block : blocks) {
			...
			DoggyTalentsMod.LOGGER.info("Successefully registered {} in {} list", block.getRegistryName(), sortingListName);
		}
	}
	...
	public void addSortingItems(String sortingListName, Item... items) throws Exception {
		...
		for(Item item : items) {
			...
			DoggyTalentsMod.LOGGER.info("Successefully registered {} in {} list", item.getRegistryName(), sortingListName);
		}
	}
}
