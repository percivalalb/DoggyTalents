...
public class NaturaLib {
	...
	public static final String[] PLANKS_1_TEXURE = new String[] {"ghostwood", "bloodwood", "darkwood", "Fusewood"};
	public static final String[] PLANKS_2_TEXURE = new String[] {"maple", "silverbell", "amaranth", "tiger", "willow", "eucalyptus", "hopseed", "sakura", "redwood"};
