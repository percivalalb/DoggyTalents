...
public class EntityDog extends EntityTameable {
    ...
    public void onLivingUpdate() {
        ...
        if(this.getDogHunger() == 0 && this.worldObj.getWorldInfo().getWorldTime() % 100L == 0L && !this.isIncapacicated()) {
    ...
    public boolean interact(EntityPlayer player) {
        ...
        else if(stack != null && stack.getItem() == ModItems.collarShears && this.reversionTime < 1 && !worldObj.isRemote) {
            this.setDead();
