...
public class DogUtil {
	...
	public static boolean isTeleportFriendlyBlock(Entity entity, World world, int xBase, int zBase, int y, int xAdd, int zAdd) {
		return World.doesBlockHaveSolidTopSurface(world, xBase + xAdd, y - 1, zBase + zAdd) && !world.getBlock(xBase + xAdd, y, zBase + zAdd).isNormalCube() && !world.getBlock(xBase + xAdd, y + 1, zBase + zAdd).isNormalCube();
