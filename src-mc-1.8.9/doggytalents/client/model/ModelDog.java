...
public class ModelDog extends ModelBase
{
    ...
    public ModelDog() {
        ...
        this.wolfHeadMainBone.addBox(-3.0F, -3.0F, -2.0F, 6, 6, 4, scaleFactor);//Bigger head for new ears
        ...
        this.wolfHeadMainBone.setTextureOffset(16, 14).addBox(-3.0F, -5.0F, 0.0F, 2, 2, 1, scaleFactor); //EarNormal1
        this.wolfHeadMainBone.setTextureOffset(16, 14).addBox(1.0F, -5.0F, 0.0F, 2, 2, 1, scaleFactor); //EarNormal2
        ...
        this.wolfHeadMainBone.setTextureOffset(52, 0).addBox(-3.8F, -3.5F, -1.0F, 2, 1, 2, scaleFactor);//SmallEar1
        this.wolfHeadMainBone.setTextureOffset(52, 0).addBox(1.8F, -3.5F, -1.0F, 2, 1, 2, scaleFactor);//SmallEar2
        
        this.wolfHeadMainBone.setTextureOffset(0, 10).addBox(-1.5F, 0.0F, -6.0F, 3, 3, 4, scaleFactor);//Nose moved
    ...
    public void render(Entity par1Entity, float par2, float par3, float par4, float par5, float par6, float par7) {
        ...
        if (this.isChild) {
            ...
            if(dog.hasBone())
            	this.wolfHeadMainBone.renderWithRotation(par7);
            else
