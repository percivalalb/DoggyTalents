...
public class Reference {
	...
	public static final String 		 DEPENDENCIES     = "REPLACE_DEPENDENCIES"; //required-after:forge@[14.21.1.2387,)
	...
	public static final String       GUI_FACTORY      = "REPLACE_GUI_FACTORY"; //TODO
