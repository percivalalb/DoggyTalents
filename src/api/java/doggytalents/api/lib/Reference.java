...
public class Reference {
    ...
    public static final String          UPDATE_URL             = "https://raw.githubusercontent.com/percivalalb/DoggyTalents/1.12.2/version.json";
    public static final String          CHANNEL_NAME           = "DOGGY";
    public static final String          GUI_FACTORY            = "doggytalents.client.gui.GuiFactory";
}
