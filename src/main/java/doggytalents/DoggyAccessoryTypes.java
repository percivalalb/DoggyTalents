...
public class DoggyAccessoryTypes {
    ...
    public static final DeferredRegister<AccessoryType> ACCESSORY_TYPES = DeferredRegister.create(DoggyTalentsAPI.RegistryKeys.ACCESSORY_TYPE_REGISTRY, Constants.MOD_ID);
