...
public class DogInfoScreen extends Screen {
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        ...
        String armorValue = Util.format2DP(this.dog.getAttribute(SharedMonsterAttributes.ARMOR).getValue());
        ...
        this.font.drawString(I18n.format("doggui.armor") + " " + armorValue, this.width - 160, topY - 70, 0xFFFFFF);
        if (ConfigValues.DOG_GENDER) {
            this.font.drawString(I18n.format("doggui.gender") + " "+ I18n.format(this.dog.getGender().getUnlocalisedName()), this.width - 160, topY - 60, 0xFFFFFF);
        }
