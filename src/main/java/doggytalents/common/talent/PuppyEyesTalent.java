    ...
    public void livingTick(DogEntity dogIn) {
        ...
        if(timeLeft <= 0) {
            ...
            if(villager != null) {
                ...
                if(rewardId == 0) {
                    //TODO player.sendMessage(new TranslationTextComponent("talent.doggytalents.puppy_eyes.msg.1.line.1", dogIn.getGenderFeature().getGenderPronoun()));
                    //player.sendMessage(new TranslationTextComponent("talent.doggytalents.puppy_eyes.msg.1.line.2", dogIn.getGenderFeature().getGenderSubject()));
                    villager.entityDropItem(Items.PORKCHOP, 2);
                } else if(rewardId == 1) {
//                    player.sendMessage(new TranslationTextComponent("talent.doggytalents.puppy_eyes.msg.2.line.1", dogIn.getGenderFeature().getGenderTitle()));
//                    player.sendMessage(new TranslationTextComponent("talent.doggytalents.puppy_eyes.msg.2.line.2", dogIn.getGenderFeature().getGenderTitle()));
//                    player.sendMessage(new TranslationTextComponent("talent.doggytalents.puppy_eyes.msg.2.line.3", dogIn.getGenderFeature().getGenderTitle()));
