...
public class ModelBake {
    ...
    public static void onModelBakeEvent(final ModelBakeEvent event) {
        ...
        try {
            ...
            IBakedModel customModel = new DogBedModel(event.getModelLoader(), model, model.bakeModel(event.getModelLoader(), ModelLoader.defaultTextureGetter(), ModelRotation.X180_Y180, unbakedModelLoc));
